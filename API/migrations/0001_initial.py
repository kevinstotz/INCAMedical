    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('images', models.ManyToManyField(related_name='templateIndicaotrImages', to='API.Image')),
                ...
                ('indicator_option', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='templateIndicatorSelectedOption', to='API.IndicatorOption', verbose_name='Template Indicator Selected Option')),
                ('notes', models.ManyToManyField(related_name='templateIndicatorNotes', to='API.Note')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('type', models.CharField(default='1', max_length=20, verbose_name='Type of Upload')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Time Updated')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Time created')),
                ('active', models.BooleanField(default=True, verbose_name='Email address Type Active')),
            ],
        ...
        migrations.AddField(
            ...
            name='uploads',
            field=models.ManyToManyField(related_name='templateIndicatorUploads', to='API.Upload'),
        ),
        migrations.AddField(
            model_name='template',
            name='categories',
