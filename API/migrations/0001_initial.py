# Generated by Django 2.1.3 on 2019-01-03 20:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.IntegerField(default=1, verbose_name='Address Type Creator')),
                ('owner', models.IntegerField(default=1, verbose_name='Address Type Owner')),
            ],
            options={
                'ordering': ('id',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('type', models.CharField(default='1', max_length=20, verbose_name='Address Type Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.IntegerField(default=1, verbose_name='Address Type Creator')),
                ('owner', models.IntegerField(default=1, verbose_name='Address Type Owner')),
                ('audit', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='auditIndicatoNoteAudit', to='API.Audit', verbose_name='Audit Indicator Note Audit')),
            ],
            options={
                'ordering': ('id',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.IntegerField(default=1, verbose_name='Address Type Creator')),
                ('owner', models.IntegerField(default=1, verbose_name='Address Type Owner')),
                ('audit', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='auditIndicatorOptionAudit', to='API.Audit', verbose_name='Audit Indicator Option Audit')),
            ],
            options={
                'ordering': ('id',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.IntegerField(default=1, verbose_name='Address Type Creator')),
                ('owner', models.IntegerField(default=1, verbose_name='Address Type Owner')),
                ('audit', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='auditIndicatorUploadAudit', to='API.Audit', verbose_name='Audit Indicator Upload Audit')),
            ],
            options={
                'ordering': ('id',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('email', models.EmailField(default='noemail@noemail.com', max_length=100, verbose_name='Email Address of Register')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Time Updated')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Time created')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('type', models.CharField(default='1', max_length=20, verbose_name='Email Address Type')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Time Updated')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Time created')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('html', models.FileField(blank=True, null=True, upload_to='API\\templates\\email', verbose_name='Email Template HTML Filename')),
                ('text', models.FileField(blank=True, null=True, upload_to='API\\templates\\email', verbose_name='Email Template Text Filename')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Time Updated')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Time created')),
                ...
                ('creator', models.IntegerField(default=1, verbose_name='Email Template Creator')),
                ('owner', models.IntegerField(default=1, verbose_name='Email Template Owner')),
            ],
            options={
                'ordering': ('id',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uploaded_name', models.CharField(blank=True, default='', max_length=255)),
                ('imagePath', models.FileField(upload_to='images/', verbose_name='Image path')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('short_name', models.CharField(blank=True, default='None', max_length=50)),
                ...
                ('images', models.ManyToManyField(related_name='indicatorImages', to='API.Image')),
            ],
            options={
                'ordering': ('id',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('type', models.CharField(default='None', max_length=50, unique=True, verbose_name='Permission Type')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Time Updated')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Time created')),
                ...
                ('creator', models.IntegerField(default=1, verbose_name='Permission Creator')),
                ('owner', models.IntegerField(default=1, verbose_name='Permission Owner')),
            ],
            options={
                'ordering': ('id',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=50, verbose_name='Person Name Name')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Time Updated')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Time created')),
                ...
                ('creator', models.IntegerField(default=1, verbose_name='Address Type Creator')),
                ('owner', models.IntegerField(default=1, verbose_name='Address Type Owner')),
                ('type', models.ForeignKey(default=1, on_delete=django.db.models.deletion.PROTECT, related_name='nameType', to='API.NameType', verbose_name='Person Name Type')),
            ],
            options={
                'ordering': ('id',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('type', models.CharField(default='1', max_length=20, verbose_name='Phone Number Type Type')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Time Updated')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Time created')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('type', models.CharField(default='None', max_length=50, unique=True, verbose_name='Role Type')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Time Updated')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Time created')),
                ...
                ('creator', models.IntegerField(default=1, verbose_name='Role Creator')),
                ('owner', models.IntegerField(default=1, verbose_name='Role Owner')),
            ],
            options={
                'ordering': ('id',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.UUIDField(default='00000000-0000-0000-0000-000000000000')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Time Updated')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Time created')),
                ...
                ('creator', models.IntegerField(default=1, verbose_name='Address Type Creator')),
                ('owner', models.IntegerField(default=1, verbose_name='Address Type Owner')),
                ('category_source', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='templateCategoryCategorySource', to='API.Category', verbose_name='Template Category Category Source')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, default='', max_length=255)),
                ('uploaded_name', models.CharField(blank=True, default='', max_length=255)),
                ('uploadPath', models.FileField(upload_to='images/', verbose_name='Upload path')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('type', models.CharField(default='1', max_length=20, verbose_name='Upload Type')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Time Updated')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Time created')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_of_birth', models.CharField(blank=True, default='1970/01/01', max_length=50, verbose_name='User Profile Date of Birth')),
                ...
                ('roles', models.ManyToManyField(related_name='userProfileRoles', to='API.Role', verbose_name='User Profile Roles')),
            ],
            options={
                'ordering': ('id',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_profile', models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='customUserUserProfile', to='API.UserProfile', verbose_name='Custom User User Profile')),
            ],
            options={
                'ordering': ('id',),
            },
        ...
        migrations.AddField(
            model_name='upload',
            name='fromUser',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='uploadFromUser', to=settings.AUTH_USER_MODEL, verbose_name='Upload From User'),
        ),
        migrations.AddField(
            model_name='upload',
            name='type',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='uploadType', to='API.UploadType', verbose_name='Upload Type'),
        ),
        migrations.AddField(
            model_name='templateindicator',
            name='indicator_options',
            field=models.ManyToManyField(related_name='templateIndicatorOptions', to='API.TemplateIndicatorOption', verbose_name='Template Indicator Options'),
        ),
        migrations.AddField(
            model_name='templateindicator',
            name='indicator_source',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='templateIndicatorIndicatorSource', to='API.Indicator', verbose_name='Template Indicator Indicator Source'),
        ),
        migrations.AddField(
            model_name='templateindicator',
            name='indicator_type',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='templateIndicatorType', to='API.TemplateIndicatorType', verbose_name='Template Indicator Type'),
        ),
        migrations.AddField(
            model_name='templateindicator',
            name='template',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='templateIndicatorTemplate', to='API.Template', verbose_name='Template Indicator Template'),
        ),
        migrations.AddField(
            model_name='template',
            name='categories',
            field=models.ManyToManyField(related_name='templateCategories', through='API.TemplateCategory', to='API.Category'),
        ),
        migrations.AddField(
            model_name='template',
            name='company',
        ...
        migrations.AddField(
            model_name='template',
            name='indicators',
            field=models.ManyToManyField(related_name='templateIndicators', through='API.TemplateIndicator', to='API.Indicator'),
        ),
        migrations.AddField(
            model_name='state',
            name='zip_codes',
        ...
        migrations.AddField(
            ...
            name='fromUser',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='notificationFromUser', to=settings.AUTH_USER_MODEL, verbose_name='Notification From User'),
        ),
        migrations.AddField(
            model_name='notification',
            name='status',
        ...
        migrations.AddField(
            model_name='note',
            name='fromUser',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='noteFromUser', to=settings.AUTH_USER_MODEL, verbose_name='Note From User'),
        ),
        migrations.AddField(
            model_name='note',
            name='type',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='noteType', to='API.NoteType', verbose_name='Note Type'),
        ),
        migrations.AddField(
            model_name='indicator',
            name='options',
            field=models.ManyToManyField(related_name='indicatorOptions', to='API.IndicatorOption'),
        ),
        migrations.AddField(
            model_name='indicator',
            name='type',
        ...
        migrations.AddField(
            model_name='emailaddress',
            name='user_profile',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='emailAddressCustomUserProfile', to='API.UserProfile', verbose_name='Email Address Custom User Profile'),
        ),
        migrations.AddField(
            model_name='company',
            name='user_profile',
        ...
        migrations.AddField(
            model_name='auditindicatorupload',
            name='indicator',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='auditIndicatorUploadIndicator', to='API.TemplateIndicator', verbose_name='Audit Indicator Upload Indicator'),
        ),
        migrations.AddField(
            model_name='auditindicatorupload',
            name='upload',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='auditIndicatorUploadOption', to='API.Upload', verbose_name='Audit Indicator Upload Option'),
        ),
        migrations.AddField(
            model_name='auditindicatoroption',
            name='indicator',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='auditIndicatorOptionIndicator', to='API.TemplateIndicator', verbose_name='Audit Indicator Option Indicator'),
        ),
        migrations.AddField(
            model_name='auditindicatoroption',
            name='option',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='auditIndicatorOptionOption', to='API.TemplateIndicatorOption', verbose_name='Audit Indicator Option Option'),
        ),
        migrations.AddField(
            model_name='auditindicatornote',
            name='indicator',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='auditIndicatorNoteIndicator', to='API.TemplateIndicator', verbose_name='Audit Indicator Note Indicator'),
        ),
        migrations.AddField(
            model_name='auditindicatornote',
            name='note',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='auditIndicatorNoteNote', to='API.Note', verbose_name='Audit Indicator Note Note'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='audit',
            name='company',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='auditCompany', to='API.Company', verbose_name='Audit Company'),
        ),
        migrations.AddField(
            model_name='audit',
            name='template',
