...
/usr/local/bin/python3 /var/www/html/incamedical/INCAMedical/manage.py runserver 172.31.2.86:10100  --configuration=Prod --settings=API.settings.Base --pythonpath=/var/www/html/incamedical/INCAMedical
